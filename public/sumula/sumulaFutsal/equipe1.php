...
"></font></b></td>
    ...
    text-decoration: line-through;"';}   ?>><?=$atletas[11]->nomeCompleto;?></font></td>
                  ...
                  <tr>
                     ...
                     <td style="border-top: 1px solid #000000;/* border-bottom: 1px solid #000000; */border-left: 1px solid #000000;/* border-right: 1px solid #000000; */" colspan="9" rowspan="2" align="center" valign="middle"><font face="Arial" size="1" color="#000000" <? if ($atletas[12]->isSuspenso==1){ echo 'style="
