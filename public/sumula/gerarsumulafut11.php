...
;
">
<form method="post" target="_blank" action="imprimirSumulaFut11.php">
					
					<label style="width:100%; padding:10px; margin:5px; color:#ffbf00; font-weight:bold; font-size:20px;" >SUMULA FUTEBOL DE CAMPO</label>
					<br> 	<br>
